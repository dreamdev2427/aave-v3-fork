...
export default function Staking() {
  ...
  // Total AQUA Emissions (stkaave dps + stkbpt dps)
              ...
              <Grid container spacing={4}>
                ...
                >
                  <StakingPanel
                    ...
                    onStakeAction={() => openStake(Stake.aave, 'AQUA')}
                    onCooldownAction={() => openStakeCooldown(Stake.aave, 'AQUA')}
                    onUnstakeAction={() => openUnstake(Stake.aave, 'AQUA')}
                    onStakeRewardClaimAction={() => openStakeRewardsClaim(Stake.aave, 'AQUA')}
                    onStakeRewardClaimRestakeAction={() =>
                      openStakeRewardsRestakeClaim(Stake.aave, 'AQUA')
                    }
                  >
                    <Box
                      sx={{
                ...
                >
                  <StakingPanel
                    ...
                    onStakeRewardClaimAction={() => openStakeRewardsClaim(Stake.gho, 'AQUA')}
                  />
                </Grid>
                ...
                >
                  <StakingPanel
                    ...
                    onStakeRewardClaimAction={() => openStakeRewardsClaim(Stake.bptv2, 'AQUA')}
                ...
                >
                  {showAbptPanel && (
                    <StakingPanel
                      ...
                      onStakeRewardClaimAction={() => openStakeRewardsClaim(Stake.bpt, 'AQUA')}
