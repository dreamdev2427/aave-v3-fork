...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    palette: {
      mode,
      primary: {
        main: getColor('#edf0fc', '#EAEBEF'),
        light: getColor('#62677B', '#F1F1F3'),
        dark: getColor('transparent', '#D2D4DC'),
      ...
      info: {
        ...
        '200': getColor('#2ebac6', '#071F2E'), // for alert background
      },
      success: {
      ...
      text: {
        primary: getColor('#f0f0f0', '#F1F1F3'),
      ...
      background: {
        default: getColor('#0C1D2F', '#1B2030'),
        paper: getColor('#08131F', '#292E41'),
        surface: getColor('#23b8c0', '#383D51'),
        surface2: getColor('#A1F4E0', '#383D51'),
        header: getColor('#0C1D2F', '#1B2030'),
        disabled: getColor('#3d3d3d', '#EBEBEF14'),
      },
      divider: getColor('#102A45', '#EBEBEF14'),
      action: {
        active: getColor('#8E92A3', '#EBEBEF8F'),
        hover: getColor('#2e2e2e', '#EBEBEF14'),
        selected: getColor('#EAEBEF', '#EBEBEF29'),
        disabled: getColor('#cecece', '#EBEBEF4D'),
      ...
      gradients: {
        aaveGradient: 'linear-gradient(248.86deg, #63d5dd 10.51%, #2EBAC6 93.41%)',
